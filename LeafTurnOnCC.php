...
$postFields = array('UserId'=>$this->userId, 'cartype'=>'', 'custom_sessionid'=>'', 'initial_app_strings'=>$this->initialAppStrings
, 'tz'=>'', 'lg'=>$this->lg, 'DCMID'=>'', 'VIN'=>'', 'RegionCode'=>$this->regionCode, 'Password'=>$this->password);
